<!-- デフォルトの pandoc.tpl を上書きする -->
<!-- https://github.com/EmaApps/emanote/blob/master/default/templates/components/pandoc.tpl -->
<ema:note:pandoc>
  <Para>
    <p class="mb-3">
      <inlines />
  ...
  <OrderedList>
    <ul class="ml-6 space-y-1 list-decimal list-inside">
      <OrderedList:Items>
        <li>
          <OrderedList:Item />
        </li>
  ...
  <Header>
    ...
    <h6 class="mt-8 mb-2 text-lg text-gray-800" />
    <!--
    以下オリジナル:
